...
class AddTricot extends StatefulWidget {
  const AddTricot({super.key});

  @override
  State<AddTricot> createState() => _AddTricotState();
}

class _AddTricotState extends State<AddTricot> {
          ...
          CustomButton(
            ...
            onPressed: () async {
              ...
              try {
                ...
                await getIt<BaseRepository<TricotDto>>().add(dto);
